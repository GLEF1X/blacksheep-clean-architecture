...
from src.utils.cqrs_lib.exceptions import MediatorExceptionCatalog
from src.utils.cqrs_lib.mediator.interface import Event
...
class MediatorImpl:
    ...
    async def handle(self, event: Event) -> Any:
        if isinstance(event, Query):
            ...
            raise MediatorExceptionCatalog.NOT_FOUND.with_params(event=event)
