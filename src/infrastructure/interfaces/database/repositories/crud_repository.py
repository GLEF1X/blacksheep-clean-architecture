...
class AbstractCRUDRepository(abc.ABC, typing.Generic[EntryType]):
    def __init__(self, model: typing.Type[EntryType] = None) -> None:
        self.model = model
    ...
    def with_changed_query_model(self, /, model: typing.Type[_T]) -> AbstractCRUDRepository[_T]:
